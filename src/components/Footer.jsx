...
const Footer = () => {
  return (
    <footer className="w-screen h-[300px] text-center flex flex-col items-center justify-between mt-[100px]">
      <h1 style={{ fontFamily: 'ananda, sans-serif'}} className="font-medium text-[30px] mt-5">
        Mohammed Ajmal Khan
      </h1>
